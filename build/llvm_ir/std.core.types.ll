...
define weak zeroext i8 @std.core.types.typeid.is_subtype_of(i64 %0, i64 %1) #0 comdat !dbg !34 {
entry:
  ...
  store i64 %1, ptr %other, align 8
    #dbg_declare(ptr %other, !42, !DIExpression(), !43)
  br label %loop.cond, !dbg !44

loop.cond:                                        ; preds = %if.exit, %entry
  %2 = load i64, ptr %self, align 8, !dbg !45
  %neq = icmp ne i64 %2, ptrtoint (ptr @"$ct.void" to i64), !dbg !45
  br i1 %neq, label %loop.body, label %loop.exit, !dbg !45

loop.body:                                        ; preds = %loop.cond
  %3 = load i64, ptr %self, align 8, !dbg !47
  %4 = load i64, ptr %other, align 8, !dbg !49
  %eq = icmp eq i64 %3, %4, !dbg !47
...
if.exit:                                          ; preds = %loop.body
  %5 = load i64, ptr %self, align 8, !dbg !51
  %"introspect*" = inttoptr i64 %5 to ptr, !dbg !51
  %ptradd = getelementptr inbounds i8, ptr %"introspect*", i64 8, !dbg !51
  %typeid.parent = load i64, ptr %ptradd, align 8, !dbg !51
  %6 = icmp eq i64 %typeid.parent, 0, !dbg !51
  %7 = select i1 %6, i64 ptrtoint (ptr @"$ct.void" to i64), i64 %typeid.parent, !dbg !51
  store i64 %7, ptr %self, align 8, !dbg !51
...
; Function Attrs: nounwind ssp uwtable
define weak zeroext i8 @std.core.types.TypeKind.is_int(i8 zeroext %0) #0 comdat !dbg !53 {
entry:
  %kind = alloca i8, align 1
  store i8 %0, ptr %kind, align 1
    #dbg_declare(ptr %kind, !56, !DIExpression(), !57)
  %1 = load i8, ptr %kind, align 1, !dbg !58
  %eq = icmp eq i8 %1, 2, !dbg !58
  br i1 %eq, label %or.phi, label %or.rhs, !dbg !58

or.rhs:                                           ; preds = %entry
  %2 = load i8, ptr %kind, align 1, !dbg !59
  %eq1 = icmp eq i8 %2, 3, !dbg !59
  br label %or.phi, !dbg !59

or.phi:                                           ; preds = %or.rhs, %entry
  %val = phi i1 [ true, %entry ], [ %eq1, %or.rhs ], !dbg !59
  %3 = zext i1 %val to i8, !dbg !59
  ret i8 %3, !dbg !59
}
...
!8 = !DIFile(filename: "types.c3", directory: "/usr/local/lib/c3/std/core")
!9 = !{!10}
!10 = !DICompositeType(tag: DW_TAG_enumeration_type, name: "TypeKind", scope: !8, file: !8, line: 349, baseType: !11, size: 8, align: 8, elements: !12)
...
!19 = !DIEnumerator(name: "ANYFAULT", value: 6, isUnsigned: true)
!20 = !DIEnumerator(name: "ANY", value: 7, isUnsigned: true)
!21 = !DIEnumerator(name: "ENUM", value: 8, isUnsigned: true)
!22 = !DIEnumerator(name: "FAULT", value: 9, isUnsigned: true)
!23 = !DIEnumerator(name: "STRUCT", value: 10, isUnsigned: true)
!24 = !DIEnumerator(name: "UNION", value: 11, isUnsigned: true)
!25 = !DIEnumerator(name: "BITSTRUCT", value: 12, isUnsigned: true)
!26 = !DIEnumerator(name: "FUNC", value: 13, isUnsigned: true)
!27 = !DIEnumerator(name: "OPTIONAL", value: 14, isUnsigned: true)
!28 = !DIEnumerator(name: "ARRAY", value: 15, isUnsigned: true)
!29 = !DIEnumerator(name: "SLICE", value: 16, isUnsigned: true)
!30 = !DIEnumerator(name: "VECTOR", value: 17, isUnsigned: true)
!31 = !DIEnumerator(name: "DISTINCT", value: 18, isUnsigned: true)
!32 = !DIEnumerator(name: "POINTER", value: 19, isUnsigned: true)
!33 = !DIEnumerator(name: "INTERFACE", value: 20, isUnsigned: true)
!34 = distinct !DISubprogram(name: "is_subtype_of", linkageName: "std.core.types.typeid.is_subtype_of", scope: !8, file: !8, line: 83, type: !35, scopeLine: 83, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !7, retainedNodes: !39)
!35 = !DISubroutineType(types: !36)
!36 = !{!37, !38, !38}
!37 = !DIBasicType(name: "bool", size: 8, encoding: DW_ATE_boolean)
!38 = !DIBasicType(name: "typeid", size: 64, encoding: DW_ATE_address)
!39 = !{}
!40 = !DILocalVariable(name: "self", arg: 1, scope: !34, file: !8, line: 83, type: !38)
!41 = !DILocation(line: 83, column: 30, scope: !34)
!42 = !DILocalVariable(name: "other", arg: 2, scope: !34, file: !8, line: 83, type: !38)
!43 = !DILocation(line: 83, column: 43, scope: !34)
!44 = !DILocation(line: 85, column: 2, scope: !34)
!45 = !DILocation(line: 85, column: 9, scope: !46)
!46 = distinct !DILexicalBlock(scope: !34, file: !8, line: 85, column: 2)
!47 = !DILocation(line: 87, column: 7, scope: !48)
!48 = distinct !DILexicalBlock(scope: !46, file: !8, line: 86, column: 2)
!49 = !DILocation(line: 87, column: 15, scope: !48)
!50 = !DILocation(line: 87, column: 29, scope: !48)
!51 = !DILocation(line: 88, column: 10, scope: !48)
!52 = !DILocation(line: 90, column: 9, scope: !34)
!53 = distinct !DISubprogram(name: "is_int", linkageName: "std.core.types.TypeKind.is_int", scope: !8, file: !8, line: 112, type: !54, scopeLine: 112, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !7, retainedNodes: !39)
!54 = !DISubroutineType(types: !55)
!55 = !{!37, !10}
!56 = !DILocalVariable(name: "kind", arg: 1, scope: !53, file: !8, line: 112, type: !10)
!57 = !DILocation(line: 112, column: 25, scope: !53)
!58 = !DILocation(line: 114, column: 9, scope: !53)
!59 = !DILocation(line: 114, column: 40, scope: !53)
