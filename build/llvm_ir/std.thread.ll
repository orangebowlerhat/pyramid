...
@"std.thread.ThreadFault$CHANNEL_CLOSED" = linkonce constant %.fault { i64 ptrtoint (ptr @"$ct.std.thread.ThreadFault" to i64), %"char[]" { ptr @.fault.11, i64 14 }, i64 12 }, comdat, align 8
@.fault.11 = internal constant [15 x i8] c"CHANNEL_CLOSED\00", align 1
...
!2 = !DIFile(filename: "thread.c3", directory: "/usr/local/lib/c3/std/threads")
