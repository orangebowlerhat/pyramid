...
@.str = private unnamed_addr constant [41 x i8] c"be00fdb253269565b5d9dadc53a9af0ac70bc714\00", align 1
@std.core.env.COMPILER_BUILD_HASH = weak local_unnamed_addr constant %"char[]" { ptr @.str, i64 40 }, comdat, align 8, !dbg !0
@.str.42 = private unnamed_addr constant [11 x i8] c"2025-02-14\00", align 1
...
@std.core.env.LLVM_VERSION = weak local_unnamed_addr constant i64 19, comdat, align 8, !dbg !143
...
!llvm.module.flags = !{!199, !200, !201, !202, !203, !204, !205}
!llvm.dbg.cu = !{!206}
...
!2 = !DIFile(filename: "env.c3", directory: "/usr/local/lib/c3/std/core")
...
!202 = !{i32 4, !"PIE Level", i32 2}
!203 = !{i32 4, !"PIC Level", i32 2}
!204 = !{i32 1, !"uwtable", i32 2}
!205 = !{i32 2, !"frame-pointer", i32 2}
!206 = distinct !DICompileUnit(language: DW_LANG_C11, file: !2, producer: "c3c", isOptimized: false, runtimeVersion: 0, emissionKind: FullDebug, enums: !207, globals: !208, splitDebugInlining: false)
!207 = !{!16, !57, !121, !151}
!208 = !{!0, !12, !14, !55, !110, !113, !115, !117, !119, !127, !129, !131, !133, !135, !137, !139, !141, !143, !145, !147, !149, !157, !159, !161, !163, !165, !167, !169, !171, !173, !175, !177, !179, !181, !183, !185, !187, !189, !191, !193, !195, !197}
